...
#define GLFW_PLATFORM_MACOS9							0x00060006
...
// defined here for agl_ctx, do not use.
extern GLFWwindow* ___curWindow;
#define agl_ctx ___curWindow->context
#include <mac_gl/agl.h>
