/*
				...
				Copyright:	� 1999 - 2001 by Apple Computer, Inc., all rights
	 reserved.
*/
...
#define AGL_RENDERER_NVIDIA_ID	  0x00280000
#define AGL_RENDERER_FORMAC_ID	  0x00021400
#define AGL_RENDERER_3DFX_ID	  0x00022400
