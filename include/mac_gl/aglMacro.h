...
#define glAccum(op, value) (*agl_ctx->disp.accum)(agl_ctx->rend, op, value)
...
#define glBegin(mode) (*agl_ctx->disp.begin)(agl_ctx->rend, mode)
...
#define glCallList(list) (*agl_ctx->disp.call_list)(agl_ctx->rend, list)

#define glCallLists(n, type, lists) \
	(*agl_ctx->disp.call_lists)(agl_ctx->rend, n, type, lists)

#define glClear(mask) (*agl_ctx->disp.clear)(agl_ctx->rend, mask)
...
#define glClearDepth(depth) (*agl_ctx->disp.clear_depth)(agl_ctx->rend, depth)

#define glClearIndex(c) (*agl_ctx->disp.clear_index)(agl_ctx->rend, c)

#define glClearStencil(s) (*agl_ctx->disp.clear_stencil)(agl_ctx->rend, s)
...
#define glDepthFunc(func) (*agl_ctx->disp.depth_func)(agl_ctx->rend, func)

#define glDepthMask(flag) (*agl_ctx->disp.depth_mask)(agl_ctx->rend, flag)

#define glDepthRange(zNear, zFar) \
	(*agl_ctx->disp.depth_range)(agl_ctx->rend, zNear, zFar)

#define glDisable(cap) (*agl_ctx->disp.disable)(agl_ctx->rend, cap)
...
#define glDrawBuffer(mode) (*agl_ctx->disp.draw_buffer)(agl_ctx->rend, mode)
...
#define glEdgeFlagv(flag) (*agl_ctx->disp.edge_flagv)(agl_ctx->rend, flag)
...
#define glEnd() (*agl_ctx->disp.end)(agl_ctx->rend)

#define glEndList() (*agl_ctx->disp.end_list)(agl_ctx->rend)

#define glEvalCoord1d(u) (*agl_ctx->disp.eval_coord1d)(agl_ctx->rend, u)

#define glEvalCoord1dv(u) (*agl_ctx->disp.eval_coord1dv)(agl_ctx->rend, u)

#define glEvalCoord1f(u) (*agl_ctx->disp.eval_coord1f)(agl_ctx->rend, u)

#define glEvalCoord1fv(u) (*agl_ctx->disp.eval_coord1fv)(agl_ctx->rend, u)

#define glEvalCoord2d(u, v) (*agl_ctx->disp.eval_coord2d)(agl_ctx->rend, u, v)

#define glEvalCoord2dv(u) (*agl_ctx->disp.eval_coord2dv)(agl_ctx->rend, u)

#define glEvalCoord2f(u, v) (*agl_ctx->disp.eval_coord2f)(agl_ctx->rend, u, v)

#define glEvalCoord2fv(u) (*agl_ctx->disp.eval_coord2fv)(agl_ctx->rend, u)
...
#define glEvalPoint1(i) (*agl_ctx->disp.eval_point1)(agl_ctx->rend, i)

#define glEvalPoint2(i, j) (*agl_ctx->disp.eval_point2)(agl_ctx->rend, i, j)

#define glFeedbackBuffer(size, type, buffer) \
	(*agl_ctx->disp.feedback_buffer)(agl_ctx->rend, size, type, buffer)

#define glFinish() (*agl_ctx->disp.finish)(agl_ctx->rend)

#define glFlush() (*agl_ctx->disp.flush)(agl_ctx->rend)

#define glFogf(pname, param) (*agl_ctx->disp.fogf)(agl_ctx->rend, pname, param)

#define glFogfv(pname, params) \
	(*agl_ctx->disp.fogfv)(agl_ctx->rend, pname, params)

#define glFogi(pname, param) (*agl_ctx->disp.fogi)(agl_ctx->rend, pname, param)
...
#define glGetError() (*agl_ctx->disp.get_error)(agl_ctx->rend)
...
#define glGetString(name) (*agl_ctx->disp.get_string)(agl_ctx->rend, name)
...
#define glHint(target, mode) (*agl_ctx->disp.hint)(agl_ctx->rend, target, mode)

#define glIndexMask(mask) (*agl_ctx->disp.index_mask)(agl_ctx->rend, mask)

#define glIndexPointer(type, stride, pointer) \
	(*agl_ctx->disp.index_pointer)(agl_ctx->rend, type, stride, pointer)

#define glIndexd(c) (*agl_ctx->disp.indexd)(agl_ctx->rend, c)

#define glIndexdv(c) (*agl_ctx->disp.indexdv)(agl_ctx->rend, c)

#define glIndexf(c) (*agl_ctx->disp.indexf)(agl_ctx->rend, c)

#define glIndexfv(c) (*agl_ctx->disp.indexfv)(agl_ctx->rend, c)

#define glIndexi(c) (*agl_ctx->disp.indexi)(agl_ctx->rend, c)

#define glIndexiv(c) (*agl_ctx->disp.indexiv)(agl_ctx->rend, c)

#define glIndexs(c) (*agl_ctx->disp.indexs)(agl_ctx->rend, c)

#define glIndexsv(c) (*agl_ctx->disp.indexsv)(agl_ctx->rend, c)

#define glIndexub(c) (*agl_ctx->disp.indexub)(agl_ctx->rend, c)

#define glIndexubv(c) (*agl_ctx->disp.indexubv)(agl_ctx->rend, c)

#define glInitNames() (*agl_ctx->disp.init_names)(agl_ctx->rend)

#define glInterleavedArrays(format, stride, pointer) \
	(*agl_ctx->disp.interleaved_arrays)(agl_ctx->rend, format, stride, pointer)

#define glIsEnabled(cap) (*agl_ctx->disp.is_enabled)(agl_ctx->rend, cap)

#define glIsList(list) (*agl_ctx->disp.is_list)(agl_ctx->rend, list)

#define glIsTexture(texture) (*agl_ctx->disp.is_texture)(agl_ctx->rend, texture)
...
#define glLineWidth(width) (*agl_ctx->disp.line_width)(agl_ctx->rend, width)

#define glListBase(base) (*agl_ctx->disp.list_base)(agl_ctx->rend, base)

#define glLoadIdentity() (*agl_ctx->disp.load_identity)(agl_ctx->rend)

#define glLoadMatrixd(m) (*agl_ctx->disp.load_matrixd)(agl_ctx->rend, m)

#define glLoadMatrixf(m) (*agl_ctx->disp.load_matrixf)(agl_ctx->rend, m)

#define glLoadName(name) (*agl_ctx->disp.load_name)(agl_ctx->rend, name)

#define glLogicOp(opcode) (*agl_ctx->disp.logic_op)(agl_ctx->rend, opcode)
...
#define glMatrixMode(mode) (*agl_ctx->disp.matrix_mode)(agl_ctx->rend, mode)

#define glMultMatrixd(m) (*agl_ctx->disp.mult_matrixd)(agl_ctx->rend, m)

#define glMultMatrixf(m) (*agl_ctx->disp.mult_matrixf)(agl_ctx->rend, m)
...
#define glNormal3bv(v) (*agl_ctx->disp.normal3bv)(agl_ctx->rend, v)

#define glNormal3d(nx, ny, nz) \
	(*agl_ctx->disp.normal3d)(agl_ctx->rend, nx, ny, nz)

#define glNormal3dv(v) (*agl_ctx->disp.normal3dv)(agl_ctx->rend, v)

#define glNormal3f(nx, ny, nz) \
	(*agl_ctx->disp.normal3f)(agl_ctx->rend, nx, ny, nz)

#define glNormal3fv(v) (*agl_ctx->disp.normal3fv)(agl_ctx->rend, v)

#define glNormal3i(nx, ny, nz) \
	(*agl_ctx->disp.normal3i)(agl_ctx->rend, nx, ny, nz)

#define glNormal3iv(v) (*agl_ctx->disp.normal3iv)(agl_ctx->rend, v)

#define glNormal3s(nx, ny, nz) \
	(*agl_ctx->disp.normal3s)(agl_ctx->rend, nx, ny, nz)

#define glNormal3sv(v) (*agl_ctx->disp.normal3sv)(agl_ctx->rend, v)
...
#define glPassThrough(token) (*agl_ctx->disp.pass_through)(agl_ctx->rend, token)
...
#define glPointSize(size) (*agl_ctx->disp.point_size)(agl_ctx->rend, size)
...
#define glPopAttrib() (*agl_ctx->disp.pop_attrib)(agl_ctx->rend)

#define glPopClientAttrib() (*agl_ctx->disp.pop_client_attrib)(agl_ctx->rend)

#define glPopMatrix() (*agl_ctx->disp.pop_matrix)(agl_ctx->rend)

#define glPopName() (*agl_ctx->disp.pop_name)(agl_ctx->rend)

#define glPrioritizeTextures(n, textures, priorities) \
	(*agl_ctx->disp.prioritize_textures)(agl_ctx->rend, n, textures, priorities)

#define glPushAttrib(mask) (*agl_ctx->disp.push_attrib)(agl_ctx->rend, mask)

#define glPushClientAttrib(mask) \
	(*agl_ctx->disp.push_client_attrib)(agl_ctx->rend, mask)

#define glPushMatrix() (*agl_ctx->disp.push_matrix)(agl_ctx->rend)

#define glPushName(name) (*agl_ctx->disp.push_name)(agl_ctx->rend, name)

#define glRasterPos2d(x, y) (*agl_ctx->disp.raster_pos2d)(agl_ctx->rend, x, y)

#define glRasterPos2dv(v) (*agl_ctx->disp.raster_pos2dv)(agl_ctx->rend, v)

#define glRasterPos2f(x, y) (*agl_ctx->disp.raster_pos2f)(agl_ctx->rend, x, y)

#define glRasterPos2fv(v) (*agl_ctx->disp.raster_pos2fv)(agl_ctx->rend, v)

#define glRasterPos2i(x, y) (*agl_ctx->disp.raster_pos2i)(agl_ctx->rend, x, y)

#define glRasterPos2iv(v) (*agl_ctx->disp.raster_pos2iv)(agl_ctx->rend, v)

#define glRasterPos2s(x, y) (*agl_ctx->disp.raster_pos2s)(agl_ctx->rend, x, y)

#define glRasterPos2sv(v) (*agl_ctx->disp.raster_pos2sv)(agl_ctx->rend, v)

#define glRasterPos3d(x, y, z) \
	(*agl_ctx->disp.raster_pos3d)(agl_ctx->rend, x, y, z)

#define glRasterPos3dv(v) (*agl_ctx->disp.raster_pos3dv)(agl_ctx->rend, v)

#define glRasterPos3f(x, y, z) \
	(*agl_ctx->disp.raster_pos3f)(agl_ctx->rend, x, y, z)

#define glRasterPos3fv(v) (*agl_ctx->disp.raster_pos3fv)(agl_ctx->rend, v)

#define glRasterPos3i(x, y, z) \
	(*agl_ctx->disp.raster_pos3i)(agl_ctx->rend, x, y, z)

#define glRasterPos3iv(v) (*agl_ctx->disp.raster_pos3iv)(agl_ctx->rend, v)

#define glRasterPos3s(x, y, z) \
	(*agl_ctx->disp.raster_pos3s)(agl_ctx->rend, x, y, z)

#define glRasterPos3sv(v) (*agl_ctx->disp.raster_pos3sv)(agl_ctx->rend, v)

#define glRasterPos4d(x, y, z, w) \
	(*agl_ctx->disp.raster_pos4d)(agl_ctx->rend, x, y, z, w)

#define glRasterPos4dv(v) (*agl_ctx->disp.raster_pos4dv)(agl_ctx->rend, v)

#define glRasterPos4f(x, y, z, w) \
	(*agl_ctx->disp.raster_pos4f)(agl_ctx->rend, x, y, z, w)

#define glRasterPos4fv(v) (*agl_ctx->disp.raster_pos4fv)(agl_ctx->rend, v)

#define glRasterPos4i(x, y, z, w) \
	(*agl_ctx->disp.raster_pos4i)(agl_ctx->rend, x, y, z, w)

#define glRasterPos4iv(v) (*agl_ctx->disp.raster_pos4iv)(agl_ctx->rend, v)

#define glRasterPos4s(x, y, z, w) \
	(*agl_ctx->disp.raster_pos4s)(agl_ctx->rend, x, y, z, w)

#define glRasterPos4sv(v) (*agl_ctx->disp.raster_pos4sv)(agl_ctx->rend, v)

#define glReadBuffer(mode) (*agl_ctx->disp.read_buffer)(agl_ctx->rend, mode)
...
#define glRectdv(v1, v2) (*agl_ctx->disp.rectdv)(agl_ctx->rend, v1, v2)

#define glRectf(x1, y1, x2, y2) \
	(*agl_ctx->disp.rectf)(agl_ctx->rend, x1, y1, x2, y2)

#define glRectfv(v1, v2) (*agl_ctx->disp.rectfv)(agl_ctx->rend, v1, v2)

#define glRecti(x1, y1, x2, y2) \
	(*agl_ctx->disp.recti)(agl_ctx->rend, x1, y1, x2, y2)

#define glRectiv(v1, v2) (*agl_ctx->disp.rectiv)(agl_ctx->rend, v1, v2)

#define glRects(x1, y1, x2, y2) \
	(*agl_ctx->disp.rects)(agl_ctx->rend, x1, y1, x2, y2)

#define glRectsv(v1, v2) (*agl_ctx->disp.rectsv)(agl_ctx->rend, v1, v2)

#define glRenderMode(mode) (*agl_ctx->disp.render_mode)(agl_ctx->rend, mode)
...
#define glScaled(x, y, z) (*agl_ctx->disp.scaled)(agl_ctx->rend, x, y, z)

#define glScalef(x, y, z) (*agl_ctx->disp.scalef)(agl_ctx->rend, x, y, z)
...
#define glShadeModel(mode) (*agl_ctx->disp.shade_model)(agl_ctx->rend, mode)

#define glStencilFunc(func, ref, mask) \
	(*agl_ctx->disp.stencil_func)(agl_ctx->rend, func, ref, mask)

#define glStencilMask(mask) (*agl_ctx->disp.stencil_mask)(agl_ctx->rend, mask)

#define glStencilOp(fail, zfail, zpass) \
	(*agl_ctx->disp.stencil_op)(agl_ctx->rend, fail, zfail, zpass)

#define glTexCoord1d(s) (*agl_ctx->disp.tex_coord1d)(agl_ctx->rend, s)

#define glTexCoord1dv(v) (*agl_ctx->disp.tex_coord1dv)(agl_ctx->rend, v)

#define glTexCoord1f(s) (*agl_ctx->disp.tex_coord1f)(agl_ctx->rend, s)

#define glTexCoord1fv(v) (*agl_ctx->disp.tex_coord1fv)(agl_ctx->rend, v)

#define glTexCoord1i(s) (*agl_ctx->disp.tex_coord1i)(agl_ctx->rend, s)

#define glTexCoord1iv(v) (*agl_ctx->disp.tex_coord1iv)(agl_ctx->rend, v)

#define glTexCoord1s(s) (*agl_ctx->disp.tex_coord1s)(agl_ctx->rend, s)

#define glTexCoord1sv(v) (*agl_ctx->disp.tex_coord1sv)(agl_ctx->rend, v)

#define glTexCoord2d(s, t) (*agl_ctx->disp.tex_coord2d)(agl_ctx->rend, s, t)

#define glTexCoord2dv(v) (*agl_ctx->disp.tex_coord2dv)(agl_ctx->rend, v)

#define glTexCoord2f(s, t) (*agl_ctx->disp.tex_coord2f)(agl_ctx->rend, s, t)

#define glTexCoord2fv(v) (*agl_ctx->disp.tex_coord2fv)(agl_ctx->rend, v)

#define glTexCoord2i(s, t) (*agl_ctx->disp.tex_coord2i)(agl_ctx->rend, s, t)

#define glTexCoord2iv(v) (*agl_ctx->disp.tex_coord2iv)(agl_ctx->rend, v)

#define glTexCoord2s(s, t) (*agl_ctx->disp.tex_coord2s)(agl_ctx->rend, s, t)

#define glTexCoord2sv(v) (*agl_ctx->disp.tex_coord2sv)(agl_ctx->rend, v)

#define glTexCoord3d(s, t, r) \
	(*agl_ctx->disp.tex_coord3d)(agl_ctx->rend, s, t, r)

#define glTexCoord3dv(v) (*agl_ctx->disp.tex_coord3dv)(agl_ctx->rend, v)

#define glTexCoord3f(s, t, r) \
	(*agl_ctx->disp.tex_coord3f)(agl_ctx->rend, s, t, r)

#define glTexCoord3fv(v) (*agl_ctx->disp.tex_coord3fv)(agl_ctx->rend, v)

#define glTexCoord3i(s, t, r) \
	(*agl_ctx->disp.tex_coord3i)(agl_ctx->rend, s, t, r)

#define glTexCoord3iv(v) (*agl_ctx->disp.tex_coord3iv)(agl_ctx->rend, v)

#define glTexCoord3s(s, t, r) \
	(*agl_ctx->disp.tex_coord3s)(agl_ctx->rend, s, t, r)

#define glTexCoord3sv(v) (*agl_ctx->disp.tex_coord3sv)(agl_ctx->rend, v)

#define glTexCoord4d(s, t, r, q) \
	(*agl_ctx->disp.tex_coord4d)(agl_ctx->rend, s, t, r, q)

#define glTexCoord4dv(v) (*agl_ctx->disp.tex_coord4dv)(agl_ctx->rend, v)

#define glTexCoord4f(s, t, r, q) \
	(*agl_ctx->disp.tex_coord4f)(agl_ctx->rend, s, t, r, q)

#define glTexCoord4fv(v) (*agl_ctx->disp.tex_coord4fv)(agl_ctx->rend, v)

#define glTexCoord4i(s, t, r, q) \
	(*agl_ctx->disp.tex_coord4i)(agl_ctx->rend, s, t, r, q)

#define glTexCoord4iv(v) (*agl_ctx->disp.tex_coord4iv)(agl_ctx->rend, v)
...
#define glVertex2d(x, y) (*agl_ctx->disp.vertex2d)(agl_ctx->rend, x, y)

#define glVertex2dv(v) (*agl_ctx->disp.vertex2dv)(agl_ctx->rend, v)

#define glVertex2f(x, y) (*agl_ctx->disp.vertex2f)(agl_ctx->rend, x, y)

#define glVertex2fv(v) (*agl_ctx->disp.vertex2fv)(agl_ctx->rend, v)

#define glVertex2i(x, y) (*agl_ctx->disp.vertex2i)(agl_ctx->rend, x, y)

#define glVertex2iv(v) (*agl_ctx->disp.vertex2iv)(agl_ctx->rend, v)

#define glVertex2s(x, y) (*agl_ctx->disp.vertex2s)(agl_ctx->rend, x, y)

#define glVertex2sv(v) (*agl_ctx->disp.vertex2sv)(agl_ctx->rend, v)

#define glVertex3d(x, y, z) (*agl_ctx->disp.vertex3d)(agl_ctx->rend, x, y, z)

#define glVertex3dv(v) (*agl_ctx->disp.vertex3dv)(agl_ctx->rend, v)

#define glVertex3f(x, y, z) (*agl_ctx->disp.vertex3f)(agl_ctx->rend, x, y, z)

#define glVertex3fv(v) (*agl_ctx->disp.vertex3fv)(agl_ctx->rend, v)

#define glVertex3i(x, y, z) (*agl_ctx->disp.vertex3i)(agl_ctx->rend, x, y, z)

#define glVertex3iv(v) (*agl_ctx->disp.vertex3iv)(agl_ctx->rend, v)

#define glVertex3s(x, y, z) (*agl_ctx->disp.vertex3s)(agl_ctx->rend, x, y, z)

#define glVertex3sv(v) (*agl_ctx->disp.vertex3sv)(agl_ctx->rend, v)

#define glVertex4d(x, y, z, w) \
	(*agl_ctx->disp.vertex4d)(agl_ctx->rend, x, y, z, w)

#define glVertex4dv(v) (*agl_ctx->disp.vertex4dv)(agl_ctx->rend, v)

#define glVertex4f(x, y, z, w) \
	(*agl_ctx->disp.vertex4f)(agl_ctx->rend, x, y, z, w)

#define glVertex4fv(v) (*agl_ctx->disp.vertex4fv)(agl_ctx->rend, v)

#define glVertex4i(x, y, z, w) \
	(*agl_ctx->disp.vertex4i)(agl_ctx->rend, x, y, z, w)

#define glVertex4iv(v) (*agl_ctx->disp.vertex4iv)(agl_ctx->rend, v)

#define glVertex4s(x, y, z, w) \
	(*agl_ctx->disp.vertex4s)(agl_ctx->rend, x, y, z, w)

#define glVertex4sv(v) (*agl_ctx->disp.vertex4sv)(agl_ctx->rend, v)
...
#define glUnlockArraysEXT() (*agl_ctx->exts.unlock_arrays_EXT)(agl_ctx->rend)
...
#define glMultTransposeMatrixdARB(m) \
	(*agl_ctx->exts.mult_transpose_matrixd_ARB)(agl_ctx->rend, m)

#define glMultTransposeMatrixfARB(m) \
	(*agl_ctx->exts.mult_transpose_matrixf_ARB)(agl_ctx->rend, m)

#define glLoadTransposeMatrixdARB(m) \
	(*agl_ctx->exts.mult_transpose_matrixd_ARB)(agl_ctx->rend, m)

#define glLoadTransposeMatrixfARB(m) \
	(*agl_ctx->exts.mult_transpose_matrixf_ARB)(agl_ctx->rend, m)
